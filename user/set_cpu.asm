...
user/_set_cpu:     file format elf64-littleriscv
...
main(int argc, char **argv)
{
  ...
  14:	1de080e7          	jalr	478(ra) # 1ee <atoi>
  18:	00000097          	auipc	ra,0x0
  1c:	376080e7          	jalr	886(ra) # 38e <set_cpu>
  20:	85aa                	mv	a1,a0
  if(cpu < 0){
  22:	02054d63          	bltz	a0,5c <main+0x5c>
  ...
  2a:	83250513          	addi	a0,a0,-1998 # 858 <malloc+0x11c>
  2e:	00000097          	auipc	ra,0x0
  32:	650080e7          	jalr	1616(ra) # 67e <printf>
  exit(0);
  36:	4501                	li	a0,0
  38:	00000097          	auipc	ra,0x0
  3c:	2b6080e7          	jalr	694(ra) # 2ee <exit>
    fprintf(2, "usage: kill pid...\n");
  40:	00000597          	auipc	a1,0x0
  44:	7e058593          	addi	a1,a1,2016 # 820 <malloc+0xe4>
  48:	4509                	li	a0,2
  4a:	00000097          	auipc	ra,0x0
  4e:	606080e7          	jalr	1542(ra) # 650 <fprintf>
    exit(1);
  52:	4505                	li	a0,1
  54:	00000097          	auipc	ra,0x0
  58:	29a080e7          	jalr	666(ra) # 2ee <exit>
    fprintf(2, "failed to change to this cpu\n"); 
...
000000000000039e <cpu_process_count>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ee:	48e50513          	addi	a0,a0,1166 # 878 <digits>
 3f2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ba:	3c2b8b93          	addi	s7,s7,962 # 878 <digits>
 ...
 5fa:	27a90913          	addi	s2,s2,634 # 870 <malloc+0x134>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c2:	1d27b783          	ld	a5,466(a5) # 890 <freep>
 ...
 6f0:	00e6ea63          	bltu	a3,a4,704 <free+0x50>
{
 ...
 732:	16f73123          	sd	a5,354(a4) # 890 <freep>
}
 736:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 764:	13053503          	ld	a0,304(a0) # 890 <freep>
 ...
 78c:	10890913          	addi	s2,s2,264 # 890 <freep>
  if(p == (char*)-1)
 790:	5afd                	li	s5,-1
 792:	a88d                	j	804 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 794:	00000797          	auipc	a5,0x0
 798:	10478793          	addi	a5,a5,260 # 898 <base>
 79c:	00000717          	auipc	a4,0x0
 7a0:	0ef73a23          	sd	a5,244(a4) # 890 <freep>
 7a4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c6:	0ca73723          	sd	a0,206(a4) # 890 <freep>
      return (void*)(p + 1);
