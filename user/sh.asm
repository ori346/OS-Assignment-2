...
0000000000000a60 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	9e048493          	addi	s1,s1,-1568 # 1478 <buf.1138>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9d3a0a13          	addi	s4,s4,-1581 # 147b <buf.1138+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	94650513          	addi	a0,a0,-1722 # 1478 <buf.1138>
...
0000000000000e7a <cpu_process_count>:
